...
func (uc *upstreamConn) sendNextPendingCommand(cmd string) {
	...
	uc.SendMessageLabeled(ctx, pendingCmd.downstreamID, true, pendingCmd.msg)
...
func (uc *upstreamConn) SendMessageLabeled(ctx context.Context, downstreamID uint64, sendLabel bool, msg *irc.Message) {
	var label string
	if sendLabel {
